    ...
    <div class="col-md-5 col-md-offset-2" style="padding: 37px 0 5px 0">
        ...
        <article class="col-lg-12 table-bordered " style="padding-top: 1px;margin-top:15px;background: white">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-12" >
                    <div class="col-md-3"><span class="glyphicon glyphicon-user"></span>余温</div>
                    <div class="col-md-6"><span class="glyphicon glyphicon-time"></span>{{date('Y年m月d日H时i',$list->time)}}</div>
                ...
                <div class="col-md-12" style="padding-top: 15px;position: relative;">
                    ...
                    <div class="col-md-3">
                        <a href="{{url('/content/'.$list->id)}}" class="btn btn-primary" style="color: white;">查看原文</a>
                    </div>
                </div>
            </div>
