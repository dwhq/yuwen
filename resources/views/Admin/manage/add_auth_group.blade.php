...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline row " action="{{url('admin/manage/add_auth_group')}}"
                  method="post">
                <div class=" col-md-6" style="margin-bottom: 10px">
                    <div class="form-group">
                        <label for="exampleInputName2">名称：</label>
                        <input type="text" class="form-control" id="title" name="title" required placeholder="请输入名称">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName2"> 描述：</label>
                        <input type="text" class="form-control" id="remark" name="remark" required placeholder="请输入描述">
                    </div>
                            ...
                            <td>
                                <ul class="list-inline row" style="margin-left: 2% ">
                                    <li class="col-md-2" dd="{{$vo->id}}"><span
                                        ...
                                        <input type="checkbox" onclick="checks(this)" name="rulers[{{$vo->id}}]" value="{{$vo->id}}" title="全选">全选下级
                                    </li>
                                </ul>
                            </td>
                        </tr>
                                ...
                                <ul class="list-inline row" style="margin-left: 2%">
                                    @foreach($vo->level as $dd)
                                        <li class="col-md-2 checkbox" dd="{{$dd->id}}"><span
                                            ...
                                            <input type="checkbox" value="{{$dd->id}}" onclick="checksup(this)" name="rulers[{{$dd->id}}]">
                                        </li>
                                    @endforeach
                                </ul>
                            </td>
